...
Simply increasing the vocabulary size of the codebook can significantly increase training time due to struggling to fit the entire embedding matrix in memory, and the model struggling to explore the entire codebook.
