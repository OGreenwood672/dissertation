...
Liu \cite{AIMotherTongue} suggested implementing Hierarchically-Quantised Variational Autoencoder (HQ-VAE) \cite{HQVAE}.
...
To test this, I applied the same analyses as in Section \ref{sec:4.3} - \ref{sec:4.7} on each codebook and on the bottom-level codebook symbols conditioned on the top-level symbols.
