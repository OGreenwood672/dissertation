...
To test this, I applied the same analyses as in Section \ref{sec:4.3} - \ref{sec:4.6} on each codebook and on the bottom-level codebook symbols conditioned on the top-level symbols.
