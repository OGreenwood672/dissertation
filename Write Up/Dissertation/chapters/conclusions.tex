...
Ultimately, the evaluation suggests that the AI Mother Tongue architecture successfully enables semantically meaningful discrete communication, outperforming both on-policy discrete and no-communication baselines by overcoming the Communication Vacuum Equilibrium in simple tasks.
...
WhisperWise performed better in the tested scaling task where AI Mother Tongue limited success.
These results suggest that reflection strategies may account for more of the performance gain than the semantic bottleneck.
...
An improvement would be applying an attention mechanisms to determine which codes are sent to which agents, similar to TarMAC \cite{tarmac}.
